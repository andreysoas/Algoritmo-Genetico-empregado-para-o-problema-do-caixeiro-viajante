...
Para a função de fitness foi reconhecido que quanto menor o valor de função objetivo para a solução, 
então maior será seu valor de fitness, logo, a função teria de ser decrescente com limite igual a zero, 
dessa forma, foi tomada uma função do tipo f(x) = 1/x , sendo x = valor de função objetivo para a solução
